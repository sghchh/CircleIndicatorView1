...
public class CircleIndicatorView extends View implements ViewPager.OnPageChangeListener{
    ...
    private int mCount;  //圆的数量
    private int mRadius;  //圆的半径
    private int mStrokeWidth;//border
    private int mTextColor;  //文字的颜色
    private int mDotNormalColor; //小圆点默认的颜色
    private int mSpace=0;  //小圆点之间的间距
    ...
    private void getAttr(Context context,AttributeSet attrs)
    {
        ...
        mRadius=(int)typedArray.getDimensionPixelSize(R.styleable.CircleIndicatorView_indicatorRadius, DisplayUtil.dpToPx(6));
        mStrokeWidth=(int)typedArray.getDimensionPixelSize(R.styleable.CircleIndicatorView_indicatorBorderWidth,DisplayUtil.dpToPx(2));
        mSpace=typedArray.getDimensionPixelSize(R.styleable.CircleIndicatorView_indicatorSpace,DisplayUtil.dpToPx(5));
        //color
        mTextColor=typedArray.getColor(R.styleable.CircleIndicatorView_indicatorTextColor,Color.BLACK);
        mSelectColor=typedArray.getColor(R.styleable.CircleIndicatorView_indicatorSelectColor,Color.BLUE);
        mDotNormalColor=typedArray.getColor(R.styleable.CircleIndicatorView_indicatorColor,Color.RED);

        mIsEnableClickSwitch=typedArray.getBoolean(R.styleable.CircleIndicatorView_enableIndicatorSwitch,Boolean.FALSE);
